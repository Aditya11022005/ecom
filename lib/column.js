...
export const DT_ORDER_COLUMN = [
    ...
    },
    {
        ...
        Cell: ({ renderedCellValue, row }) => (
            row?.original?.paymentMethod || (row?.original?.payment_id && row?.original?.payment_id.toString().startsWith('COD_') ? 'COD' : 'Online')
        )
    },
    {
        ...
        Cell: ({ renderedCellValue, row }) => {
            ...
            const paid = !isCOD && row?.original?.payment_id
