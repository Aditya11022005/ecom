        ...
        <footer className='bg-gray-50 border-t'>
                ...
                <div>
                    ...
                    <ul>
                        <li className='mb-2 text-gray-500 flex gap-2'>
                            ...
                            <span className='text-sm'>Aruzz India Pune, India 411017</span>
                        </li>
                        <li className='mb-2 text-gray-500 flex gap-2'>
                            <MdOutlinePhone size={20} />
                            <Link href="tel:+91-8569874589" className='hover:text-primary text-sm'>+91-9561680380</Link>
                        </li>
                        <li className='mb-2 text-gray-500 flex gap-2'>
                            <MdOutlineMail size={20} />
                            <Link href="mailto:aruz.india@gmail.com" className='hover:text-primary text-sm'>aruz.india@gmail.com</Link>
                        </li>
            ...
            <div className='py-5 bg-gray-100' >
                <div className='container mx-auto px-4 flex flex-col md:flex-row items-center justify-center gap-2'>
                    <p className='text-center md:text-left'>© 2025 Aruzz India. All Rights Reserved.</p>
                    <p className='text-center md:text-left text-sm text-gray-500'>Developed by <span className='font-semibold text-gray-700'>Mordspark</span></p>
                </div>
            </div>
